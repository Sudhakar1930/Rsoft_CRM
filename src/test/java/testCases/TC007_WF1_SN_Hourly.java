...
public class TC007_WF1_SN_Hourly extends BaseClass {
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC007_WF1_CRM_Schedule_Notify_Hourly");
	}
		
	@Test
	public void testScheduleNotify () throws Exception {
		node = test.createNode("Schedule_Notify_Hourly");
		
		logger.info("******starting WF Schedule Notify Hourly****");
...
//		String sPath=".\\testData\\Schedule\\" + "Schedule_Notify_Hourly" + "_Live.xlsx" ;
		String sPath=".\\testData\\Schedule\\" + "Schedule_Notify_Hourly" + "_Test.xlsx" ;
