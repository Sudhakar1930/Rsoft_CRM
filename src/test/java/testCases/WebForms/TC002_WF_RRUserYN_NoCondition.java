...
public class TC002_WF_RRUserYN_NoCondition extends BaseClass {
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC002_WF_RRUserYN_NoCondition");
	}
	...
	public void testWFUserAvailYesorNo() throws Exception {
		...
		node = test.createNode("RRUserYN_NoCondition");
		...
		String sPath="\\WebForm\\TC002_WF_RRUserYN_NoCondition_";
		...
		String sMainPath=".\\testData\\WebForm\\" + "TC002_WF_RRUserYN_NoCondition" + "_Test.xlsx" ;
