...
public class TC022_WF_RRY_OneN_TwoN extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC022_WF_RRY_OneN_TwoN");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		...
		String sPath="\\WebForm\\TC022_WF_RRY_OneN_TwoN_";
		...
		String sMainPath=".\\testData\\WebForm\\TC022_WF_RRY_OneN_TwoN" + "_Test.xlsx" ;
