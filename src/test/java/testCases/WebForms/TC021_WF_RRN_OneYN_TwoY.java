...
public class TC021_WF_RRN_OneYN_TwoY extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC021_WF_RRN_OneYN_TwoY");
	}
	
	@Test	
	public void testWebFormUser() throws Exception {
		node = test.createNode("WF_RRN_OneYN_TwoY");
		...
		String sPath="\\WebForm\\TC021_WF_RRN_OneYN_TwoY_";
		...
		String sMainPath=".\\testData\\WebForm\\TC021_WF_RRN_OneYN_TwoY" + "_Test.xlsx" ;
