...
public class TC011_WF_RRUserN_OneConditionN extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC011_WF_RRUserN_OneConditionN");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		node = test.createNode("RRUserYN_OneConditionY");
		...
		String sUserName9 = xlObj.getCellData("Sheet1", 1, 43);
		String sUser9Avail = xlObj.getCellData("Sheet1", 1, 44);
		String sUser9Admin = xlObj.getCellData("Sheet1", 1, 45);
		
		String sUserName10 = xlObj.getCellData("Sheet1", 1, 46);
		String sUser10Avail = xlObj.getCellData("Sheet1", 1, 47);
		String sUser10Admin = xlObj.getCellData("Sheet1", 1, 48);

		String sUserName11 = xlObj.getCellData("Sheet1", 1, 49);
		String sUser11Avail = xlObj.getCellData("Sheet1", 1, 50);
		String sUser11Admin = xlObj.getCellData("Sheet1", 1, 51);
		
		String sUserName12 = xlObj.getCellData("Sheet1", 1, 52);
		String sUser12Avail = xlObj.getCellData("Sheet1", 1, 53);
		String sUser12Admin = xlObj.getCellData("Sheet1", 1, 54);
		
		
		String sWebFormId = xlObj.getCellData("Sheet1", 1, 55);
