...
public class TC038_WF_RRYN_OneYN_TwoYN extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC038_WF_RRYN_OneYN_TwoYN");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		node = test.createNode("WF_RRYN_OneYN_TwoYN");
		...
		String sPath="\\WebForm\\TC038_WF_RRYN_OneYN_TwoYN_";
		...
		String sMainPath=".\\testData\\WebForm\\TC038_WF_RRYN_OneYN_TwoYN" + "_Test.xlsx" ;
