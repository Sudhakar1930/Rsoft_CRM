...
public class TC037_WF_RRYN_OneYN_TwoN extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC037_WF_RRYN_OneYN_TwoN");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		node = test.createNode("WF_RRYN_OneY_TwoY");
		...
		String sPath="\\WebForm\\TC037_WF_RRYN_OneYN_TwoN_";
		...
		String sMainPath=".\\testData\\WebForm\\TC037_WF_RRYN_OneYN_TwoN" + "_Test.xlsx" ;
