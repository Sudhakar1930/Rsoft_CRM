...
public class TC031_WF_RRYN_OneN_TwoN extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC031_WF_RRYN_OneN_TwoN");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		...
		String sPath="\\WebForm\\TC031_WF_RRYN_OneN_TwoN_";
		...
		String sMainPath=".\\testData\\WebForm\\TC031_WF_RRYN_OneN_TwoN" + "_Test.xlsx" ;
