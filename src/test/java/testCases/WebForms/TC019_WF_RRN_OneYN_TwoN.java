...
public class TC019_WF_RRN_OneYN_TwoN extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC019_WF_RRN_OneYN_TwoN");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		...
		String sPath="\\WebForm\\TC019_WF_RRN_OneYN_TwoN_";
		...
		String sMainPath=".\\testData\\WebForm\\TC019_WF_RRN_OneYN_TwoN" + "_Test.xlsx" ;
