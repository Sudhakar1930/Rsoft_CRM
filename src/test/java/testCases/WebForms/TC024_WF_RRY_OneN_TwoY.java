...
public class TC024_WF_RRY_OneN_TwoY extends BaseClass {
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC024_WF_RRY_OneN_TwoY");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		...
		String sPath="\\WebForm\\TC024_WF_RRY_OneN_TwoY_";
		...
		String sMainPath=".\\testData\\WebForm\\TC024_WF_RRY_OneN_TwoY" + "_Test.xlsx" ;
