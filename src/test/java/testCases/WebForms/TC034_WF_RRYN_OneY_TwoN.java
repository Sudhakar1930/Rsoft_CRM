...
public class TC034_WF_RRYN_OneY_TwoN extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC034_WF_RRYN_OneY_TwoN");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		node = test.createNode("WF_RRYN_OneY_TwoN");
		...
		String sPath="\\WebForm\\TC034_WF_RRYN_OneY_TwoN_";
		...
		String sMainPath=".\\testData\\WebForm\\TC034_WF_RRYN_OneY_TwoN" + "_Test.xlsx" ;
