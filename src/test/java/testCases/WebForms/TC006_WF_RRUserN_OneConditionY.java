...
public class TC006_WF_RRUserN_OneConditionY extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC006_WF_RRUserN_OneConditionY");
	}
	
	@Test	
	public void testWebFormUser() throws Exception {
		node = test.createNode("RRUserN_OneConditionY");
		...
		String sPath="\\WebForm\\TC006_WF_RRUserN_OneConditionY_";
		...
		String sMainPath=".\\testData\\WebForm\\" + "TC006_WF_RRUserN_OneConditionY" + "_Test.xlsx" ;
