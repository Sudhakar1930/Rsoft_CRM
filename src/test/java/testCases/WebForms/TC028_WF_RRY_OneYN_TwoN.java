...
public class TC028_WF_RRY_OneYN_TwoN extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC028_WF_RRY_OneYN_TwoN");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		node = test.createNode("WF_RRY_OneYN_TwoN");
		...
		String sPath="\\WebForm\\TC028_WF_RRY_OneYN_TwoN_";
		...
		String sMainPath=".\\testData\\WebForm\\TC028_WF_RRY_OneYN_TwoN" + "_Test.xlsx" ;
