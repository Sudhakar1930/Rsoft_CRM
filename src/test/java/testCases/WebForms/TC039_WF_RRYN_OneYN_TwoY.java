...
public class TC039_WF_RRYN_OneYN_TwoY extends  BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC039_WF_RRYN_OneYN_TwoY");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		node = test.createNode("WF_RRYN_OneYN_TwoY");
		...
		String sPath="\\WebForm\\TC039_WF_RRYN_OneYN_TwoY_";
		...
		String sMainPath=".\\testData\\WebForm\\TC039_WF_RRYN_OneYN_TwoY" + "_Test.xlsx" ;
