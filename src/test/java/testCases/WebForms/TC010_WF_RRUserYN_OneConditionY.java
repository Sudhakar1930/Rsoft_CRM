...
public class TC010_WF_RRUserYN_OneConditionY extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC010_WF_RRUserYN_OneConditionY");
	}
	...
	public void testWebFormUser() throws Exception {
		...
		String sWebFormId = xlObj.getCellData("Sheet1", 1, 43);
...
//				 IndvObj.setPhoneNumber(sRandPhoneNo);
				...
				}//If Condition 1 Matches or Not Matches
