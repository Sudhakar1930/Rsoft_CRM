...
public class TC035_WF_RRYN_OneY_TwoYN extends BaseClass{
	@BeforeTest
	public void testName() {
		test = extent.createTest("TC035_WF_RRYN_OneY_TwoYN");
	}
	@Test	
	public void testWebFormUser() throws Exception {
		node = test.createNode("WF_RRYN_OneY_TwoYN");
		...
		String sPath="\\WebForm\\TC035_WF_RRYN_OneY_TwoYN_";
		...
		String sMainPath=".\\testData\\WebForm\\TC035_WF_RRYN_OneY_TwoYN" + "_Test.xlsx" ;
