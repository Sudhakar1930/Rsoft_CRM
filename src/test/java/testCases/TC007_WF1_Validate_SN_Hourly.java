...
public class TC007_WF1_Validate_SN_Hourly extends BaseClass {
	
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC001_Schedule_Notify_Hourly");
	}
	
	@Test
	public void testDatainPhpMyAdmin () throws Exception {
		node = test.createNode("Validate_Schedule_Notify");
