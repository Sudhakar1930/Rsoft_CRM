...
import utilities.UtilityCustomFunctions;
	...
	public class TC003_WF3_Notify_ETR_M extends BaseClass {
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC003_WF3_ETR_M_Notify");
	}
	
	@Test
	public void testNotify_ETR_M () throws Exception {
		node = test.createNode("WF3_Notify_ETR_M");
...
//		String sPath=".\\testData\\Notification\\" + "WF3_Notify_ETR_M_Live" + ".xlsx" ;
		String sPath=".\\testData\\Notification\\" + "WF3_Notify_ETR_M__Test" + ".xlsx" ;
...
//		}//If workflow Enabled but Task not set
		...
		//**************Add New Record
		objCRMRs.fAddValuestoModulePage("Test","//Notification//WF3_Every_time_record_modifies_","Sheet1");
		String sNotCount=""; 
		...
		objCRMRs.fValidateAllFields("Test", "WF3_Every_time_record_modifies_","Sheet1","Module Data Validation","No",node);
		...
		objCRMRs.fAddValuestoModulePage("Test","WF3_Every_time_record_modifies_","Sheet1");
		Thread.sleep(3000);
		sNotCount = objCRMRs.fgetNotificationCount();
		if(sNotCount==null) {
			sNotCount = "0";
		...
		objCRMRs.fValidateAllFields("Test", "WF3_Every_time_record_modifies_","Sheet1","After New Record added","No",node);
