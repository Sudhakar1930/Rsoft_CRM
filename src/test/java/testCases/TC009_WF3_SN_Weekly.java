...
public class TC009_WF3_SN_Weekly extends BaseClass {
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC009_WF1_ScheduleNotify_Weekly");
	}
...
//		String sPath=".\\testData\\Schedule\\" + "Schedule_Notify_Weekly" + "_Live.xlsx" ;
		String sPath=".\\testData\\Schedule\\" + "Schedule_Notify_Weekly" + "_Test.xlsx" ;
