...
public class TC020_CreateEntity_ETRS_DefaultValues extends BaseClass{
	@BeforeTest()
	public void CreateTest() {
		UtilityCustomFunctions.logWriteConsole("Extent Test Creation");
		test = extent.createTest("TC020_CreateEntity_ETRS_DefaultValues");
	...
	public void testCreateEntity_ETRS_DefaultValues() throws Exception {
		...
		logger.info("******starting TC020_CreateEntity_ETRS_DefaultValues ****");
...
//		String sPath=".\\testData\\CreateEntity\\" + "CreateEntity_ETRS_DefaultValues" + "_Live.xlsx" ;
		String sPath=".\\testData\\CreateEntity\\" + "CreateEntity_ETRS_DefaultValues" + "_Test.xlsx";
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
//		objCRMRs.fAddValuestoEntityModule("Test","//CreateEntity//CreateEntity_ETRS_DefaultValues_","Sheet1",false);
		objCRMRs.fAddMandatoryValuestoEntityModule("Test","//CreateEntity//CreateEntity_ETRS_DefaultValues_","Sheet1");
		...
		if(iOldTrgRecId == iCurrTrgRecId) {
			freport("Target Entity Not Created for @Add New Default Values", "fail", node);
		}
		else {
			objCRMRs.fValidateEntityResponse("Test", "//CreateEntity//CreateEntity_ETRS_DefaultValues_","Sheet5","@Add New - Default Values in Target","No",node,true);
			freport("Target Entity Created for @Add New Default Values", "pass", node);
		}
		...
		if(iOldSrcRecId!=iCurrSrcRecId) {
			freport("@Summary Add New Source record added", "pass", node);
			
		}
		else {
			freport("@Summary Add New Source record not added", "fail", node);
		...
		if(iOldTrgRecId != iCurrTrgRecId) {
			objCRMRs.fValidateEntityResponse("Test", "//CreateEntity//CreateEntity_ETRS_DefaultValues_","Sheet5","@Summary Add New - Default Values in Target","No",node,true);
		...
		UtilityCustomFunctions.logWriteConsole("Old TargetId: "+iOldTrgRecId +"New TargetId: "+iCurrTrgRecId);
		if(iOldTrgRecId != iCurrTrgRecId) {
			objCRMRs.fValidateEntityResponse("Test", "//CreateEntity//CreateEntity_ETRS_DefaultValues_","Sheet5","Target Entity @Duplicate Record","No",node,true);
			freport("Target Entity Created after Record Duplicated", "pass", node);
			
			}
		else {
			freport("Target Entity not Created after Record Duplicated", "fail", node);	
		}
		...
		UtilityCustomFunctions.logWriteConsole("Old TargetId: "+iOldTrgRecId +"New TargetId: "+iCurrTrgRecId);
		if(iOldTrgRecId != iCurrTrgRecId) {
			objCRMRs.fValidateEntityResponse("Test", "//CreateEntity//CreateEntity_ETRS_DefaultValues_","Sheet5","Target Entity Edit & Save","No",node,true);
			freport("Target Entity Created after Record Edit & Saved", "pass", node);
			}
		else {
			freport("Target Entity not Created after Record @Edit & Save", "fail", node);	
		}
		...
		if(iOldTrgRecId== iCurrTrgRecId) {
			...
			objCRMRs.fValidateEntityResponse("Test", "//CreateEntity//CreateEntity_ETRS_DefaultValues_","Sheet5","Target Entity @Single Line Edit","No",node,true);
