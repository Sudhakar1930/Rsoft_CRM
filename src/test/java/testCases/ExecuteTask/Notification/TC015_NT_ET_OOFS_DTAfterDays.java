...
public class TC015_NT_ET_OOFS_DTAfterDays extends BaseClass {
	@BeforeTest()
	public void testName() {
		System.out.println("DTAfterDays");
		test = extent.createTest("TC015_NT_ET_OOFS_DTAfterDays");
	}
	@Test
	public void testExecuteTask_DTAfterDays () throws Exception {
		node = test.createNode("NT_ExecuteTask_DTAfterDays");
		UtilityCustomFunctions.logWriteConsole("******starting TC015_NT_ET_OOFS_DTAfterDays ****");
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ET_NT_OOFS_DTAfterDays_Live" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ET_NT_OOFS_DTAfterDays_Test" + ".xlsx" ;
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterDays_","Sheet1",false,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
//		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterDays_","Sheet1","@Add New", node);
...
//		dExpDate = DateUtils.addMinutes(dExpDate, 720);
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterDays_","Sheet2",false,"sDateandTime");
		
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
//		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterDays_","Sheet2","@Summary Add New", node);
...
//		dExpDate = DateUtils.addMonths(dExpDate, 12);
		...
		//********************************* Duplicate Add Record ************************************
			...
			objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterDays_","Sheet3",true,"sDateandTime");
				
			UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
			
//			objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterDays_","Sheet3","@Duplicate Add New", node);
