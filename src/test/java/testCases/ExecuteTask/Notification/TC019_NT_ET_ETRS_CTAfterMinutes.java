...
public class TC019_NT_ET_ETRS_CTAfterMinutes extends BaseClass{
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC019_NT_ET_ETRS_CTAfterMinutes");
	}
	@Test
	public void testET_NT_ETRS_CTAfterMinutes () throws Exception {
		node = test.createNode("NT_ExecuteTask_CTAfterMinutes");
		UtilityCustomFunctions.logWriteConsole("******starting TC019_NT_ET_ETRS_CTAfterMinutes ****");
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_CTAfterMinutes_Live" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_CTAfterMinutes_Test" + ".xlsx" ;
...
//		objCRMRs.fClickFirstRecord();
		Thread.sleep(2000);
		objCRMRs.fAddValuestoETNotification("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_CTAfterMinutes_","Sheet1",false);
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_CTAfterMinutes_","Sheet1","Add New Data Validation", node);
		...
		objCRMRs.fAddValuestoETNotification("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_CTAfterMinutes_","Sheet2",false);
		...
		Thread.sleep(3000);
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_CTAfterMinutes_","Sheet2","Summary Page Add New", node);
		Thread.sleep(2000);
		sCurrModRecId = objCRMRs.getModuleRecordId();
	...
	//Login as User 1
		...
		objCRMRs.fAddValuestoETNotification("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_CTAfterMinutes_","Sheet3",true);
		objDVP.fSetToggleHeader(true);
		objDVP.fSetDetailVew(false);
		objSVP.fWaitTillControlVisible();
		driver.navigate().refresh();
		Thread.sleep(3000);
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_CTAfterMinutes_","Sheet3","Duplicate Record", node);
		sCurrModRecId = objCRMRs.getModuleRecordId();
		...
		objCRMRs.fAddValuestoETNotification("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_CTAfterMinutes_","Sheet4",true);
		objDVP.fSetToggleHeader(true);
		objDVP.fSetDetailVew(false);
		objSVP.fWaitTillControlVisible();
		driver.navigate().refresh();
		Thread.sleep(3000);
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_CTAfterMinutes_","Sheet4","Edit & Save Record", node);
		sCurrModRecId = objCRMRs.getModuleRecordId();
