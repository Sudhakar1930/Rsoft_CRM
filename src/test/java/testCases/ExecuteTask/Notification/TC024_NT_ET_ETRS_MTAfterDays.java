...
public class TC024_NT_ET_ETRS_MTAfterDays extends BaseClass{
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC024_NT_ET_ETRS_MTAfterDays");
	}
	@Test
	public void testExecuteTask_NT_MTAfterDays () throws Exception {
		node = test.createNode("NT_ExecuteTask_MTAfterDays");
		UtilityCustomFunctions.logWriteConsole("******starting TC024_NT_ET_ETRS_MTAfterDays ****");
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_MTAfterDays_Live" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_MTAfterDays_Test" + ".xlsx" ;
...
//			objHP.clickAvatar();
		...
		if(isEntity==false) {
			objBase.freport(" Actual EntityId: "+sCurrModRecId + " not created in DB @New Record" , "pass",node);
		...
		objCRMRs.fAddValuestoETNotification("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_MTAfterDays_","Sheet2",false);
		...
		objCRMRs.fAddValuestoETNotification("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_MTAfterDays_","Sheet3",true);
		objDVP.fSetToggleHeader(true);
		objDVP.fSetDetailVew(false);
		objSVP.fWaitTillControlVisible();
		driver.navigate().refresh();
