...
public class TC033_NT_ET_ETRS_DTBeforeHours extends BaseClass{
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC033_NT_ET_ETRS_DTBeforeHours");
	}
	@Test
	public void testExecuteTask__DTBeforeHours () throws Exception {
		
		node = test.createNode("NT_ExecuteTask_DTBeforeHours");
		UtilityCustomFunctions.logWriteConsole("******starting TC033_NT_ET_ETRS_DTBeforeHours ****");
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_DTBeforeHours_Test" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_DTBeforeHours_Test" + ".xlsx" ;
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeHours_","Sheet1",false,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeHours_","Sheet1","@Add New", node);
		...
		if(sActualValue.equalsIgnoreCase(sExpDate)) {
			objBase.freport("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New" , "pass",node);
			UtilityCustomFunctions.logWriteConsole("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New"); 
			BaseClass.sAssertinFn.assertEquals("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New","Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New");
		}else {
			objBase.freport("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New" , "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New"); 
			BaseClass.sAssertinFn.assertEquals("Failed: Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New","Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New");
		}
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeHours_","Sheet2",false,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
//		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeHours_","Sheet2","@Summary Add New", node);
		...
		if(sActualValue.equalsIgnoreCase(sExpDate)) {
			objBase.freport("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New" , "pass",node);
			UtilityCustomFunctions.logWriteConsole("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New"); 
			...
			objBase.freport("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New" , "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New"); 
			BaseClass.sAssertinFn.assertEquals("Failed: Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New","Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New");
		}
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeHours_","Sheet3",true,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		sCurrModRecId = objCRMRs.getModuleRecordId();
		...
		System.out.println("Expected Formatted Date & Time" + sExpDate);
		if(sActualValue.equalsIgnoreCase(sExpDate)) {
			objBase.freport("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record" , "pass",node);
			UtilityCustomFunctions.logWriteConsole("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record"); 
			BaseClass.sAssertinFn.assertEquals("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record","Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record");
		}else {
			objBase.freport("Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record" , "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record"); 
			BaseClass.sAssertinFn.assertEquals("Failed: Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record","Execute Task Notification Date&Time before Hours Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record");
		}
		...
		objCMD.clickEdit();
		Thread.sleep(3000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeHours_","Sheet4",true,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		sCurrModRecId = objCRMRs.getModuleRecordId();
		Thread.sleep(2000);
