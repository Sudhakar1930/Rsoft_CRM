...
public class TC029_NT_ET_ETRS_TimeAfterHours extends BaseClass{
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC029_NT_ET_ETRS_TimeAfterHours");
	}
	@Test
	public void testExecuteTask_TimeAfterHours () throws Exception {
		node = test.createNode("NT_ExecuteTask_TimeAfterHours");
		UtilityCustomFunctions.logWriteConsole("******starting TC029_NT_ET_ETRS_TimeAfterHours ****");
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_TimeAfterHours_Live" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_TimeAfterHours_Test" + ".xlsx" ;
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_TimeAfterHours_","Sheet1",false,"sTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_TimeAfterHours_","Sheet1","@Add New Validation", node);
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_TimeAfterHours_","Sheet2",false,"sTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_TimeAfterHours_","Sheet3",true,"sTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		...
		if(sConfigDateTime.contains(sExp_Time)) {
			...
			BaseClass.sAssertinFn.assertEquals("Failed: ET Time after Hours With Actual Configured Time: " + sConfigDateTime + " Expected Time: "+ sExp_Time + " EntityId: "+sCurrModRecId + "@Duplicate Add New","ET Time after Hours With Configured Time: " + sConfigDateTime + "Expected Time: "+ sExp_Time+ " EntityId: "+sCurrModRecId + "@Duplicate Add New");
		}
...
//		
		...
		objCMD.clickEdit();
		Thread.sleep(3000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_TimeAfterHours_","Sheet4",true,"sTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		sCurrModRecId = objCRMRs.getModuleRecordId();
		Thread.sleep(2000);
		...
		if(sConfigDateTime.contains(sExp_Time)) {
			...
			BaseClass.sAssertinFn.assertEquals("ET Time after Hours With Configured Time: " + sConfigDateTime + " Expected Time: "+ iExp_Hour+":00:00" + " EntityId: "+sCurrModRecId + "@Edit & Save","ET Time after Hours With Configured Time: " + sConfigDateTime + "Expected Time: "+ sExp_Time + " EntityId: "+sCurrModRecId + "@Edit & Save");
		}else {
			...
			BaseClass.sAssertinFn.assertEquals("Failed: ET Time after Hours With Actual Configured Time: " + sConfigDateTime + " Expected Time: "+ sExp_Time + " EntityId: "+sCurrModRecId + "@Edit & Save","ET Time after Hours With Configured Time: " + sConfigDateTime + "Expected Time: "+ sExp_Time+ " EntityId: "+sCurrModRecId + "@Edit & Save");
		}
