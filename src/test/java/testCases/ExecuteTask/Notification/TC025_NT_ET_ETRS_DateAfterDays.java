...
public class TC025_NT_ET_ETRS_DateAfterDays extends BaseClass{
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC025_NT_ET_ETRS_DateAfterDays");
	}
	@Test
	public void testExecuteTask_DateAfterDays () throws Exception {
		node = test.createNode("NT_ExecuteTask_DateAfterDays");
		UtilityCustomFunctions.logWriteConsole("******starting TC025_NT_ET_ETRS_DateAfterDays ****");
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DateAfterDays_","Sheet1",false,"sDate");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DateAfterDays_","Sheet1","@Add Mew", node);
...
//		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		...
		//********************************* Summary Add ************************************
			...
			Thread.sleep(3000);
			objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DateAfterDays_","Sheet2",false,"sDate");
			UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
			Thread.sleep(2000);
			sCurrModRecId = objCRMRs.getModuleRecordId();
			Thread.sleep(2000);
			...
			sExecFrom_Time=xlObj.getCellData("Sheet2", 1, 10);
			System.out.println("Date as is: " + sActExeStart_Time + " " + sExecFrom_Time);
//			SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			//Date as is: 2024-05-11 07:30:08 10-05-2024
			...
			objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DateAfterDays_","Sheet3",true,"sDate");
			UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
			Thread.sleep(2000);
			sCurrModRecId = objCRMRs.getModuleRecordId();
			Thread.sleep(2000);
			objHP.clickLogoutCRM();
			sActExeStart_Time =objPAP.fGetExecutionStartTime(sMySqlUrl,sMySqlUid,sMySqlPwd,"rsoft_workflowtask_queue",sCurrModRecId);
			sExecFrom_Time=xlObj.getCellData("Sheet3", 1, 10);
			System.out.println("Date as is: " + sActExeStart_Time + " " + sExecFrom_Time);
//				SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			//Date as is: 2024-05-11 07:30:08 10-05-2024
...
//				SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			...
			format2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			 ...
			 if(numberOfDays==1) {
				 ...
				 BaseClass.sAssertinFn.assertEquals("Date Selected: "+ d1 +" And Execution Start Date: "+d2 +"Execute Task Notification Days after given Date is: "+numberOfDays +" days and "+ "EntityId: "+sCurrModRecId + "@Edit & Save","Execute Task Notification Days after given Date is: "+numberOfDays +" days and "+ "EntityId: "+sCurrModRecId + "@Edit & Save");
			 }else {
				 ...
				 UtilityCustomFunctions.logWriteConsole("Date Selected: "+ d1 +" And Execution Start Date: "+d2 +"Failed: Execute Task Notification Days after given Date is: "+numberOfDays +" days and "+ "EntityId: "+sCurrModRecId + "@Edit & Save"); 
				 BaseClass.sAssertinFn.assertEquals("Date Selected: "+ d1 +" And Execution Start Date: "+d2 +"Failed: Execute Task Notification Days after given Date is: "+numberOfDays +" days and "+ "EntityId: "+sCurrModRecId + "@Edit & Save","Execute Task Notification Days after given Date is: "+numberOfDays +" days and "+ "EntityId: "+sCurrModRecId + "@Edit & Save"); 
			 }
			  objLP.clickPHPMyAdminLogout();
			  Thread.sleep(1000); 
