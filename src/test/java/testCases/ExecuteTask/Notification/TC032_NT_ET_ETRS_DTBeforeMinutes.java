...
public class TC032_NT_ET_ETRS_DTBeforeMinutes extends BaseClass{
	@BeforeTest()
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_DTBeforeMinutes_Live" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_DTBeforeMinutes_Test" + ".xlsx" ;
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeMinutes_","Sheet1",false,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeMinutes_","Sheet1","@Add New", node);
		...
		if(sActualValue.equalsIgnoreCase(sExpDate)) {
			objBase.freport("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New" , "pass",node);
			UtilityCustomFunctions.logWriteConsole("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New"); 
			BaseClass.sAssertinFn.assertEquals("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New","Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New");
		}else {
			objBase.freport("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New" , "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New"); 
			BaseClass.sAssertinFn.assertEquals("Failed: Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New","Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Add New");
		}
		...
		//********************************* Summary Add ************************************
				...
				objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeMinutes_","Sheet2",false,"sDateandTime");
				UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
				Thread.sleep(2000);
//				objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeMinutes_","Sheet2","@Summary Add New", node);
				...
				if(sActualValue.equalsIgnoreCase(sExpDate)) {
					objBase.freport("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New" , "pass",node);
					UtilityCustomFunctions.logWriteConsole("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New"); 
					...
					objBase.freport("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New" , "fail",node);
					UtilityCustomFunctions.logWriteConsole("Failed: Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New"); 
					BaseClass.sAssertinFn.assertEquals("Failed: Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New","Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Summary Add New");
				}
				...
				objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeMinutes_","Sheet3",true,"sDateandTime");
				UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
				Thread.sleep(2000);
				sCurrModRecId = objCRMRs.getModuleRecordId();
				...
				if(sActualValue.equalsIgnoreCase(sExpDate)) {
					objBase.freport("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record" , "pass",node);
					UtilityCustomFunctions.logWriteConsole("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record"); 
					BaseClass.sAssertinFn.assertEquals("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record","Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record");
				}else {
					objBase.freport("Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record" , "fail",node);
					UtilityCustomFunctions.logWriteConsole("Failed: Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record"); 
					BaseClass.sAssertinFn.assertEquals("Failed: Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record","Execute Task Notification Date&Time before Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Duplicate Record");
				}
				...
				objCMD.clickEdit();
				Thread.sleep(3000);
				objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTBeforeMinutes_","Sheet4",true,"sDateandTime");
				UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
				Thread.sleep(2000);
				sCurrModRecId = objCRMRs.getModuleRecordId();
				Thread.sleep(2000);
