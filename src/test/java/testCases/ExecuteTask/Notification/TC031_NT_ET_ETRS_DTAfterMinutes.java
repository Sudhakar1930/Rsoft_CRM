...
public class TC031_NT_ET_ETRS_DTAfterMinutes extends BaseClass{
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC031_NT_ET_ETRS_DTAfterMinutes");
	}
	@Test
	public void testExecuteTask__DTAfterMinutes () throws Exception {
		node = test.createNode("NT_ExecuteTask_DTAfterMinutes");
		UtilityCustomFunctions.logWriteConsole("******starting TC031_NT_ET_ETRS_DTAfterMinutes ****");
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_DTAfterMinutes_Live" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_DTAfterMinutes_Test" + ".xlsx" ;
...
//			objHP.clickAvatar();
	...
	Thread.sleep(2000);
	objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTAfterMinutes_","Sheet1",false,"sDateandTime");
	UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
	Thread.sleep(2000);
	objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTAfterMinutes_","Sheet1","@Add New", node);
	...
	//********************************* Summary Add ************************************
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTAfterMinutes_","Sheet2",false,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
//		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTAfterMinutes_","Sheet2","@Summary Add New", node);
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTAfterMinutes_","Sheet3",true,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		sCurrModRecId = objCRMRs.getModuleRecordId();
		...
		newDate = DateUtils.addMinutes(d1, 330);
		sConfigDateTime = newDate.toString();
		System.out.println("Config datetime:@Duplicate Record" + sConfigDateTime);
		sActualFormat = new SimpleDateFormat("E MMM dd HH:mm:ss Z yyyy");
		sTargetFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		sExpConvFromFormat = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss a");
		date = sActualFormat.parse(sConfigDateTime);
		...
		objCMD.clickEdit();
		Thread.sleep(3000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_DTAfterMinutes_","Sheet4",true,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		sCurrModRecId = objCRMRs.getModuleRecordId();
		Thread.sleep(2000);
		...
		if(sActualValue.equalsIgnoreCase(sExpDate)) {
			...
			UtilityCustomFunctions.logWriteConsole("Passed: Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Edit & Save"); 
