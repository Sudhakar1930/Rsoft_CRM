...
public class TC049_NT_ET_ETRM_DTAfterMinutes extends BaseClass{
	@BeforeTest()
	public void testName() {
		System.out.println("Before Test Method");
		test = extent.createTest("TC049_NT_ET_ETRM_DTAfterMinutes");
	}
	@Test
	public void testExecuteTask__DTAfterMinutes () throws Exception {
		node = test.createNode("NT_ExecuteTask_DTAfterMinutes");
		UtilityCustomFunctions.logWriteConsole("******starting TC049_NT_ET_ETRM_DTAfterMinutes ****");
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRM\\ET_NT_ETRM_DTAfterMinutes_Live" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRM\\ET_NT_ETRM_DTAfterMinutes_Test" + ".xlsx" ;
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRM//ET_NT_ETRM_DTAfterMinutes_","Sheet1",false,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
//		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRM//ET_NT_ETRM_DTAfterMinutes_","Sheet1","@Add New", node);
		...
		if(bFlag==false) {
		 objBase.freport("Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Add New", "pass",node);
		 UtilityCustomFunctions.logWriteConsole("Passed: Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Add New");
		 BaseClass.sAssertinFn.assertEquals("Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Add New","Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Add New");
		}
		else {
			objBase.freport("Actual EntityId: "+sCurrModRecId + " Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Add New", "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Add New");
			BaseClass.sAssertinFn.assertEquals("Failed: Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Add New","Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Add New");
		}
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRM//ET_NT_ETRM_DTAfterMinutes_","Sheet2",false,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
//		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRM//ET_NT_ETRM_DTAfterMinutes_","Sheet2","@Summary Add New", node);
		...
		bFlag = objPAP.IsEntityInQueue(sMySqlUrl, sMySqlUid, sMySqlPwd,"rsoft_workflowtask_queue", sCurrModRecId);
		if(bFlag==false) {
		 objBase.freport("Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Summary Add", "pass",node);
		 UtilityCustomFunctions.logWriteConsole("Passed: Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Summary Add");
		 BaseClass.sAssertinFn.assertEquals("Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Summary Add","Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Summary Add");
		}
		else {
			objBase.freport("Actual EntityId: "+sCurrModRecId + " Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Summary Add", "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Summary Add");
			BaseClass.sAssertinFn.assertEquals("Failed: Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Summary Add","Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Summary Add");
		}
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRM//ET_NT_ETRM_DTAfterMinutes_","Sheet3",true,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		sCurrModRecId = objCRMRs.getModuleRecordId();
		...
		bFlag = objPAP.IsEntityInQueue(sMySqlUrl, sMySqlUid, sMySqlPwd,"rsoft_workflowtask_queue", sCurrModRecId);
		if(bFlag==false) {
		 objBase.freport("Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Duplicate Record", "pass",node);
		 UtilityCustomFunctions.logWriteConsole("Passed: Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Duplicate Record");
		 BaseClass.sAssertinFn.assertEquals("Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Duplicate Record","Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Duplicate Record");
		}
		else {
			objBase.freport("Actual EntityId: "+sCurrModRecId + " Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Duplicate Record", "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Duplicate Record");
			BaseClass.sAssertinFn.assertEquals("Failed: Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Duplicate Record","Actual EntityId: "+sCurrModRecId + " Not Created in DB for Every Time Record Modifies condition for DTAfterMinutes Task @Duplicate Record");
		}
		...
		objCMD.clickEdit();
		Thread.sleep(3000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRM//ET_NT_ETRM_DTAfterMinutes_","Sheet4",true,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		sCurrModRecId = objCRMRs.getModuleRecordId();
		Thread.sleep(2000);
		...
		if(sActualValue.equalsIgnoreCase(sExpDate)) {
			objBase.freport("Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Edit & Save" , "pass",node);
			UtilityCustomFunctions.logWriteConsole("Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Edit & Save"); 
			BaseClass.sAssertinFn.assertEquals("Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Edit & Save","Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Edit & Save");
		}else {
			objBase.freport("Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Edit & Save" , "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Edit & Save"); 
			BaseClass.sAssertinFn.assertEquals("Failed: Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Edit & Save","Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Edit & Save");
		}
		...
		System.out.println("Config datetime:@Edit & Save" + sConfigDateTime);
		...
		if(sActualValue.equalsIgnoreCase(sExpDate)) {
			objBase.freport("Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Single Line Edit" , "pass",node);
			UtilityCustomFunctions.logWriteConsole("Passed: Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Single Line Edit"); 
			BaseClass.sAssertinFn.assertEquals("Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Single Line Edit","Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Single Line Edit");
		}else {
			objBase.freport("Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Single Line Edit" , "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Single Line Edit"); 
			BaseClass.sAssertinFn.assertEquals("Failed: Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Single Line Edit","Execute Task Notification Date&Time after Minutes Actual Value: " + sActualValue + "Expected Value: "+ sExpDate + " EntityId: "+sCurrModRecId + "@Single Line Edit");
		}
