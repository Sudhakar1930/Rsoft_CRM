...
public class TC014_NT_ET_OOFS_DTAfterHours extends BaseClass{
	@BeforeTest()
	public void testName() {
		System.out.println("DTAfterHours");
		test = extent.createTest("TC014_NT_ET_OOFS_DTAfterHours");
	}
	@Test
	public void testExecuteTask__DTAfterHours () throws Exception {
		node = test.createNode("NT_ExecuteTask_DTAfterHours");
		UtilityCustomFunctions.logWriteConsole("******starting TC014_NT_ET_OOFS_DTAfterHours ****");
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ET_NT_OOFS_DTAfterHours_Live" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ET_NT_OOFS_DTAfterHours_Test" + ".xlsx" ;
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterHours_","Sheet1",false,"sDateandTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterHours_","Sheet1","@Add New", node);
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterHours_","Sheet2",false,"sDateandTime");
		
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterHours_","Sheet2","@Summary Add New", node);
		...
		//********************************* Duplicate Add Record ************************************
			...
			objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterHours_","Sheet3",true,"sDateandTime");
				
			UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
			
			objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ET_NT_OOFS_DTAfterHours_","Sheet3","@Duplicate Add New", node);
