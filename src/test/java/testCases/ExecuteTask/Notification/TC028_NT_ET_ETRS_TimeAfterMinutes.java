...
public class TC028_NT_ET_ETRS_TimeAfterMinutes extends BaseClass{
	@BeforeTest()
...
//		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_TimeAfterMinutes_Live" + ".xlsx" ;
		String sPath=".\\testData\\ExecuteTask\\Notification\\ETRS\\ET_NT_ETRS_TimeAfterMinutes_Test" + ".xlsx" ;
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_TimeAfterMinutes_","Sheet1",false,"sTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
//		objCRMRs.fVerifyETNotificationSummary("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_TimeAfterMinutes_","Sheet1","@Add New", node);
		...
		if(sAMorPM.equalsIgnoreCase("AM")){
			sAfterMinutes = "0" + sHours + ":45:00";
		}
		else {
			iHours = Integer.parseInt(sHours) + 12;
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_TimeAfterMinutes_","Sheet2",false,"sTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
...
//		sAfterMinutes = "0" + sHours + ":45:00";
		...
		iHours = 0;
		if(sAMorPM.equalsIgnoreCase("AM")){
			sAfterMinutes = "0" + sSHours + ":45:00";
		}
		else {
			iHours = Integer.parseInt(sSHours) + 12;
			sAfterMinutes = String.valueOf(iHours)+":45:00";
		}
		...
		objCRMRs.fAddValuestoETBySpecificValues("Test","//ExecuteTask//Notification//ETRS//ET_NT_ETRS_TimeAfterMinutes_","Sheet3",true,"sTime");
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sExpModuleName);
		Thread.sleep(2000);
...
//		sAfterMinutes = "0" + sHours + ":45:00";
		...
		iHours = 0;
		if(sAMorPM.equalsIgnoreCase("AM")){
			sAfterMinutes = "0" + sMHours + ":45:00";
		}
		else {
			iHours = Integer.parseInt(sMHours) + 12;
			sAfterMinutes = String.valueOf(iHours)+":45:00";
		}
		
		if(sConfigDateTime.contains(sAfterMinutes)) {
			objBase.freport("ET Time after Minutes With Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Duplicate Add New" , "pass",node);
			UtilityCustomFunctions.logWriteConsole("Passed: ET Time after Minutes With Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Duplicate Add New"); 
			BaseClass.sAssertinFn.assertEquals("ET Time after Minutes With Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Duplicate Add New","ET Time before Hours With Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Duplicate Add New");
		}else {
			objBase.freport("ET Time sAfterMinutes With Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Duplicate Add New" , "fail",node);
			UtilityCustomFunctions.logWriteConsole("Failed: ET Time before Hours With Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Duplicate Add New"); 
			BaseClass.sAssertinFn.assertEquals("ET Time before Hours With Actual Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Duplicate Add New","ET Time before Hours With Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Duplicate Add New");
		}
...
//		sAfterMinutes = "0" + sHours + ":45:00";
		...
		if(sConfigDateTime.contains(sAfterMinutes)) {
			...
			BaseClass.sAssertinFn.assertEquals("Failed: ET Time before Hours With Actual Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Edit & Save","ET Time before Hours With Configured Time: " + sConfigDateTime + "Expected Time: "+ sAfterMinutes + " EntityId: "+sCurrModRecId + "@Edit & Save");
		}
