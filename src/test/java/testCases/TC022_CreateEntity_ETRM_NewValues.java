...
public class TC022_CreateEntity_ETRM_NewValues extends BaseClass{
	@BeforeTest()
	public void CreateTest() {
		UtilityCustomFunctions.logWriteConsole("Extent Test Creation");
		test = extent.createTest("TC022_CreateEntity_ETRM_NewValues");
...
//		String sPath=".\\testData\\CreateEntity\\" + "CreateEntity_ETRM_NewValues" + "_Live.xlsx" ;
		String sPath=".\\testData\\CreateEntity\\" + "CreateEntity_ETRM_NewValues" + "_Test.xlsx";
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoEntityModule("Test","//CreateEntity//CreateEntity_ETRM_NewValues_","Sheet1",false);
		...
		if(iOldTrgRecId == iCurrTrgRecId) {
			freport("Target Entity Not Created @Add New @ETRM", "pass", node);
		}
		else {
			freport("Target Entity Created @Add New @ETRM", "fail", node);
		}
		...
		Thread.sleep(3000);
		objCRMRs.fAddValuestoEntityModule("Test","//CreateEntity//CreateEntity_ETRM_NewValues_","Sheet2",false);
		UtilityCustomFunctions.logWriteConsole("New Record added in: "+sDisplayMod1);
		UtilityCustomFunctions.fWaitNavLink(sExpSrcModuleName);
		iCurrSrcRecId= objCRMRs.getLastRecordId();
		
		if(iOldSrcRecId!=iCurrSrcRecId) {
			freport("New Source Record Added @Summary Add and @ETRM", "pass", node);
			
		}
		else {
			freport("New Source Record Not Added @Summary Add and @ETRM", "fail", node);
		...
		if(iOldTrgRecId == iCurrTrgRecId) {
			freport("Target Entity Not Created @Summary Add and @ETRM", "pass", node);
		}
		else {
			freport("Target Entity Created @Summary Add and @ETRM", "fail", node);
		}
		...
		objCRMRs.fAddValuestoEntityModule("Test","//CreateEntity//CreateEntity_ETRM_NewValues_","Sheet3",true);
		...
		iCurrSrcRecId= objCRMRs.getLastRecordId();
		if(iOldSrcRecId!=iCurrSrcRecId) {
			freport("New Source Record Added @Duplicate and @ETRM", "pass", node);
			
		}
		else {
			freport("New Source Record not Added @Duplicate and @ETRM", "fail", node);
		}
		...
		if(iOldTrgRecId == iCurrTrgRecId) {
			freport("Target Entity Not Created @Duplicate Add and @ETRM", "pass", node);
		}
		else {
			freport("Target Entity Created @Duplicate Add and @ETRM", "fail", node);
		}
		...
		objCMD.clickEdit();
		Thread.sleep(3000);
		objCRMRs.fAddValuestoEntityModule("Test","//CreateEntity//CreateEntity_ETRM_NewValues_","Sheet4",true);
		...
		if(iOldTrgRecId != iCurrTrgRecId) {
			freport("Target Entity Created @Edit & Save and @ETRM", "pass", node);
			objCRMRs.fValidateEntityResponse("Test", "//CreateEntity//CreateEntity_ETRM_NewValues_","Sheet4","Target Entity @Edit & Save","No",node,true);
			}
		else {
			freport("Target Entity not Created @Edit & Save and @ETRM", "fail", node);	
		}
		...
		Thread.sleep(1000);
		if(iOldTrgRecId== iCurrTrgRecId) {
			freport("Target Entity Not Created @Single Line Edit for @ETRM", "fail", node);
		}else {
			freport("Target Entity Created @Single Line Edit for @ETRM", "pass", node);
		}
		Thread.sleep(2000);
