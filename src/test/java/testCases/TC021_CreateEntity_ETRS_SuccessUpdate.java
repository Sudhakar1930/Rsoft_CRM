...
public class TC021_CreateEntity_ETRS_SuccessUpdate extends BaseClass{
	@BeforeTest()
	public void CreateTest() {
		UtilityCustomFunctions.logWriteConsole("Extent Test Creation");
		test = extent.createTest("TC021_CreateEntity_ETRS_SuccessUpdate");
	...
	public void testCreateEntity_ETRS_DefaultValues() throws Exception {
		node = test.createNode("CreateEntity_ETRS_SuccessUpdate");
		UtilityCustomFunctions.logWriteConsole("Extent Test Node Created");
		
		logger.info("********** starting TC021_CreateEntity_ETRS_SuccessUpdate ***************");
...
//			objHP.clickAvatar();
		...
		Thread.sleep(2000);
		objCRMRs.fAddValuestoEntityModule("Test","//CreateEntity//CreateEntity_ETRS_SuccessUpdate_","Sheet1",false);
		...
		if(iOldSrcRecId==iCurrSrcRecId) {
			...
			objCRMRs.fValidateEntityResponse("Test", "//CreateEntity//CreateEntity_ETRS_SuccessUpdate_","Sheet5","Update on Success Case-@Add New","No",node,false);
