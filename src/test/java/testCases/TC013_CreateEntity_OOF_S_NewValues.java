...
public class TC013_CreateEntity_OOF_S_NewValues extends BaseClass{
	@BeforeTest()
	public void CreateTest() {
		UtilityCustomFunctions.logWriteConsole("Extent Test Creation");
		test = extent.createTest("CreateEntity_OOF_S_NewValues");
		UtilityCustomFunctions.logWriteConsole("Extent Test Created");
	}
	@Test
	public void testCreateEntity_OOF_S_NewVal() throws Exception {
...
//		int iTarRecId = 98496;
		...
		if(iTarRecId == iTarAfterNewRec) {
			...
			objCRMRs.fValidateEntityModuleSummary("Test", "//CreateEntity//CreateEntity_OOFS_NewValues_","Sheet1","Create Entity in Target","No",node);
		}
